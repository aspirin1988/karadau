...
(function () {
  ...
  window.show_trigger = function (that) {
    var container = document.querySelector('.uk-container-custom');
    var nav = document.querySelector('*[data-side-nav]');
    var logo_mini = document.querySelector('#logo-mini');
    var logo_big = document.querySelector('#logo-big');
  ...
  if (JSON.parse(localStorage.getItem('menu_collapse'))) {
    ...
    var logo_mini = document.querySelector('#logo-mini');
    var logo_big = document.querySelector('#logo-big');
    var span = document.querySelector('#trigger_menu span');
    span.setAttribute('uk-icon', 'grid');
    nav.classList.add('collapse');
    logo_mini.classList.add('active');
    logo_mini.classList.remove('uk-hidden');
...
/***/ 2:
/*!*****************************************!*\
  !*** multi ./resources/js/app_icons.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/serg/PhpstormProjects/karada/resources/js/app_icons.js */"./resources/js/app_icons.js");
