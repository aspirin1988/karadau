		...
		<div class="uk-margin-top">
			...
			<ul class="uk-comment-list">
				<li v-for="item in list">
					<feedback_list_item-component :item="item" :key="item.id" @Delete="Delete"></feedback_list_item-component>
				</li>
			</ul>
...
<script>
    export default {
        ...
        methods: {
            getList:function () {
                this.$http.get('/admin/feedback/get_list/' + this.current_page).then(response => {
