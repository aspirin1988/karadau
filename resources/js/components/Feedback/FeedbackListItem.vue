<template>
	<article class="uk-comment uk-textarea uk-position-relative">
		<header class="uk-comment-header uk-question-grid">
			<div>
				<h4 class="uk-comment-title uk-margin-remove">
					<a :href="'/admin/feedback/edit/'+item.id" class="uk-link-reset">{{item.title}}</a>
				</h4>
			...
			<div class="uk-comment-footer uk-padding-small" :class="classObject">
				<a class="uk-button uk-button-default uk-background-muted uk-button-secondary" :href="'/admin/feedback/edit/'+item.id">
		...
		<div class="uk-comment-body uk-position-relative">
			<p class="uk-padding-small uk-padding-remove-top" v-html="item.text"></p>
		</div>
	</article>
</template>
