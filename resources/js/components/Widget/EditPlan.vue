    ...
    <div>
        <div class="sales_plan_body_grid">
            <div class="sales_plan_body_item block" v-for="item in list">
                ...
                <span class="plan">{{new Intl.NumberFormat('ru-RU').format(parseInt(item.fact.toString().replace(/\s/g, '')))}}</span>
                <pie-component :value="getPercent(item)"></pie-component>
                <button @click="ShowEdit(item)" class="button round button-gray-stroke">редактировать</button>
            </div>
        </div>
                ...
                <div class="block modal-body">
                    ...
                    <div class="form">
                        <div class="row" v-if="current_plan" >
                            ...
                            <input ref="plan_input" type="text" v-model="current_plan.fact" @keyup="setFormat" @keypress="Checked">
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            ShowEdit: function (item) {
                ...
                this.current_plan.fact = this.current_plan.fact.toString();
                this.setFormat();
                this.$refs['plan_input'].select();
