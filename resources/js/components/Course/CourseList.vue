<template>
    <div>
                    ...
                    <div class="uk-inline">
                        ...
                        <div uk-dropdown>
                            <ul class="uk-nav uk-nav-default">
                                <li class="">
                                    <a href="/admin/course/add" title="Курс">
                                        <i uk-icon="template"></i><span>Курс</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="uk-margin-top">
            ...
            <!--                                            :path="'/admin/course/'"></widget-paginator-component>-->
            ...
            <!--                                        <a :href="'/admin/course/edit/'+item.id" class="uk-link-reset">{{item.title}}</a>-->
            <!--                                    </h4>-->
            ...
            <!--                                       :href="'/admin/course/edit/'+item.id">-->
    ...
    export default {
        ...
        methods: {
            deletePage: function (item) {
                this.$http.delete('/admin/course/delete/' + this.delete_item.id).then(response => {
            ...
            getList: function () {
                ...
                this.$http.post('/admin/course/get', pros).then(response => {
