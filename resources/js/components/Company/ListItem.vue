		...
		<header class="uk-comment-header uk-question-grid">
			<div>
				<h4 class="uk-comment-title uk-margin-remove">
					<a :href="'/admin/company/edit/'+item.id" class="uk-link-reset">{{item.name}}</a>
				</h4>
			...
			<div class="uk-comment-footer uk-padding-small" :class="classObject">
				<a class="uk-button uk-button-default uk-background-muted uk-button-secondary" :href="'/admin/company/edit/'+item.id">
