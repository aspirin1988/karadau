                            ...
                            <div class="uk-padding-small">
                                <div class="uk-margin-small">
                                    ...
                                    <div class="uk-inline">
                                        ...
                                        <input :id="'alt_'+key" class="uk-input uk-form-width-large uk-form-width-large" v-model="item.data.alt" type="text">
                                    </div>
                                </div>
                                <div class="uk-margin-small">
                                    ...
                                    <div class="uk-inline">
                                        <a href="#" uk-icon="icon: check" class="uk-form-icon uk-form-icon-flip uk-icon" @click="updateMedia(item.data.id,item.data)" onclick="return false;" ></a>
                                        <input :id="'video_'+key" class="uk-input uk-form-width-large uk-form-width-large" v-model="item.data.video" type="text">
                                    </div>
                                </div>
                                <div class="uk-margin-small">
                                    <label :for="'sort_'+key" class="uk-form-label">Sort:</label><br>
                                    <div class="uk-inline">
                                        <input :id="'sort_'+key" class="uk-input uk-form-width-large uk-form-width-large" @change="updateSort(item.id, item.order_field)" v-model="item.order_field" type="number">
                                    </div>
                                </div>
