<div style="color:#333333;font-family:Arial,sans-serif;font-size:14px;line-height:1.429">
    <table cellpadding="0" cellspacing="0" width="100%"
           style="border-collapse:collapse;background-color:#ffffff;border-collapse:collapse" bgcolor="#f5f5f5">
        <tbody>
        <tr>
                ...
                <table cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse">
                    ...
                    <tr>
                        <td style="padding:0px;border-collapse:collapse;vertical-align:middle;font-family:Arial,sans-serif;font-size:18px;line-height:20px">
                            <strong>Вас зарегистрировали </strong><br>
                            <div style="margin-top:10px; color:#3b73af;text-decoration:none">На сайте <a href="http://karadau.kz">Karadau.kz</a>
                            </div>
                        </td>
                    </tr>
                    </tbody>
                                        ...
                                        <span style="font-family:Arial,sans-serif;padding:0;font-size:15px;line-height:30px;vertical-align:middle">
                                            <p style="color:#000;text-decoration:none">
                                                <strong>Password:</strong><span
                                                        style="margin-left: 10px;">{{$password}}</span>
                                            </p>
                                        </span>
                                    </td>
                                </tr>
