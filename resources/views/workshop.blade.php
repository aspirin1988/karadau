    ...
    <section id="slider" class="slider">
        <div class="uk-height-viewport uk-overflow-hidden">
            ...
            <div
                ...
                <div class="uk-width-1-2@s uk-position-relative uk-height-medium uk-visible@s">
        ...
        <div class="uk-container uk-container-small uk-padding">
            ...
            <ul uk-accordion>
                <li class="uk-open uk-card uk-card-default uk-card-body">
                    <a class="uk-accordion-title" href="#">Блок 1: Маркетинг</a>
                ...
                <li class="uk-card uk-card-default uk-card-body">
                    <a class="uk-accordion-title" href="#">Блок 2: Реклама</a>
                    <div class="uk-accordion-content uk-flex uk-flex-center">
                ...
                <li class="uk-card uk-card-default uk-card-body">
                    <a class="uk-accordion-title" href="#">Блок 3: Продвижение</a>
                ...
                <li class="uk-card uk-card-default uk-card-body">
                    <a class="uk-accordion-title" href="#">Блок 4: Продажи</a>
                    <div class="uk-accordion-content">
                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                            pariatur. Excepteur sint occaecat cupidatat proident.</p>
                    </div>
